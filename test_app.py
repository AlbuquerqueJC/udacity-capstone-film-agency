...
database_path = os.environ.get('DATABASE_URL', "postgresql:///{}"
                               .format("capstone_test"))


# Errors with this "postgresql://jca@localhost:5432/capstone_test"
# Use this: "export DATABASE_URL=postgresql:///capstone_test"
...
#   - test_error_401_delete_actor (Authentication)
#   Executive Producer:
#   - test_error_401_delete_movie (Authorization)
#   - test_error_401_delete_movie (Authentication)
...
class AgencyTestCase(unittest.TestCase):
    ...
    def test_error_404_get_actors(self):
        ...
        self.assertFalse(data['success'])
        self.assertEqual(data['message'], 'No actors to list')
    ...
    def test_error_404_edit_actor_invalid_id(self):
    ...
    def test_error_401_delete_actor_no_auth(self):
    ...
    def test_error_404_get_movies(self):
        ...
        self.assertEqual(res.status_code, 404)
        self.assertFalse(data['success'])
        self.assertEqual(data['message'], 'No movies to list')
    ...
    def test_edit_movie(self):
        ...
        res = self.client().patch('/movies/2', json=json_edit_movie,
                                  headers=executive_producer_auth_header)
        data = json.loads(res.data)
    ...
    def test_error_401_delete_movie_wrong_permissions(self):
